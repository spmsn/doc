...
## 3. Expérimentation NE555

Le NE555 a différents usages :

- Timer (temporisateur, minuterie)
- Oscillateur (clignotant)
- Bascule RS (2 boutons on et off)
- Bascule on/off avec 1 bouton

Expérimentez ces 4 possibilités grâce à la vidéo suivante.

<YouTube id="L_rsaJjDeIA" />
